...
- Attack type classification:
  - **Authority Attack**: Impersonates trusted institutions
  - **Urgency Attack**: Creates artificial time pressure
  - **Fear/Panic Attack**: Uses threats and alarming language
  - **Greed Trap**: Offers unrealistic rewards
...
- Three risk levels:
  - **BLOCK** (>70): Hard stop, page blurred
  - **WARNING** (30-70): User choice, inputs protected
  - **SAFE** (<30): Allow with soft notification
